...
def scale(cnp.ndarray[cnp.float64_t, ndim=2] detections,
    ...
    ndarray, shape (N, 5), dtype float64
        ...
        the scale factor.
    Ref: https://github.com/chanwutk/pyxtrackers/blob/main/references/bytetrack/byte_tracker.py#L171-L173 (scale = min(...); bboxes /= scale)
    Ref: https://github.com/chanwutk/pyxtrackers/blob/main/references/ocsort/ocsort.py#L213-L215 (same scaling pattern)
    """
    cdef:
        ...
        # Ref: https://github.com/chanwutk/pyxtrackers/blob/main/references/bytetrack/byte_tracker.py#L172 (scale = min(img_size[0]/float(img_h), ...))
    ...
    # Ref: https://github.com/chanwutk/pyxtrackers/blob/main/references/bytetrack/byte_tracker.py#L173 (bboxes /= scale)
