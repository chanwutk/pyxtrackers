...
#
# Ref: references/sort/kalman_filter.py (KalmanFilter7x4 class)
# ============================================================================

# Kalman filter struct for 7D state, 4D measurement.
# Ref: references/sort/kalman_filter.py#L9-L16 (KalmanFilter7x4.__init__)
cdef struct KalmanFilter:
    double x[7]          # State vector [x, y, s, r, vx, vy, vs]. Ref: references/sort/kalman_filter.py#L11 (self.x)
    double P[7][7]       # Error covariance (7x7). Ref: references/sort/kalman_filter.py#L12 (self.P)
    double Q[7][7]       # Process noise covariance (7x7). Ref: references/sort/kalman_filter.py#L13 (self.Q)
    double F[7][7]       # State transition matrix (7x7). Ref: references/sort/kalman_filter.py#L14 (self.F)
    double H[4][7]       # Measurement matrix (4x7). Ref: references/sort/kalman_filter.py#L15 (self.H)
    double R[4][4]       # Measurement noise covariance (4x4). Ref: references/sort/kalman_filter.py#L16 (self.R)
