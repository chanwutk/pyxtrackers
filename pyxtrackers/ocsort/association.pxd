...
cdef enum AssoFuncType:
    ASSO_IOU = 0      # Ref: references/ocsort/association.py#L5-L21 (iou_batch)
    ASSO_GIOU = 1     # Ref: references/ocsort/association.py#L24-L56 (giou_batch)
    ASSO_DIOU = 2     # Ref: references/ocsort/association.py#L59-L96 (diou_batch)
    ASSO_CIOU = 3     # Ref: references/ocsort/association.py#L98-L149 (ciou_batch)
    ASSO_CT_DIST = 4  # Ref: references/ocsort/association.py#L152-L173 (ct_dist)
